...
class AuthCredentialDaoTest : PostgreSqlTestBase() {
    ...
    inner class FindByLibraryUserId {
        @Test
        fun `given inserted credential when find by library user id then returns record`() {
        ...
        @Test
        fun `given missing user id when find by library user id then returns null`() {
