...
- `MUST` verify Command architecture rules in section 5.1.
- `MUST` verify Command domain classification rules in section 5.1.4.
- `MUST` verify Query architecture rules in section 6.1.
- `MUST` verify Command API rules in section 5.2.
- `MUST` verify Query API rules in section 6.2.
- `MUST` verify Command/Query separated test rules in sections 5.3 and 6.3.
