...
- 仕様間の参照はユーザーストーリーからユースケースへ向け、ユースケースからモデル、イベント、制約、用語へ向ける。
- モデル仕様、イベント仕様、制約仕様には、それらを利用するユースケースへの逆参照を持たない。
...
- 検索で複数候補が見つかった場合は、ユーザーストーリーの「関連ユースケース」からユースケースを辿り、ユースケース文書の「関連モデル・イベント・制約」「用語」を辿って対象を確定する。
...
- ユーザーストーリーでは関連するユースケースへのリポジトリ相対リンクを記載する。
- ユースケース仕様では関連する用語、モデル、イベント、制約へのリポジトリ相対リンクを記載する。
